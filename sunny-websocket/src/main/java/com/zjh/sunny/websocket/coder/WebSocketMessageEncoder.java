 ...
 */
public class WebSocketMessageEncoder extends MessageToMessageEncoder<WsMessage> {
    ...
    @Override
    protected void encode(ChannelHandlerContext ctx, WsMessage msg, List<Object> out) throws Exception {
        logger.debug("======= 出站数据编码 =======");
        try {
            //将对象转换为byte
